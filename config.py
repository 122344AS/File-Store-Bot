...
BOT_USERNAME = environ.get("BOT_USERNAME", "SA_file_store_bot") # your bot username without @
PICS = (environ.get('PICS', 'https://graph.org/file/82ef767ffebe3a948e476.jpg https://graph.org/file/82ef767ffebe3a948e476.jpg')).split() # Bot Start Picture

# Auto Delete Information
AUTO_DELETE = int(environ.get("AUTO_DELETE", "1000000000")) # Time in Minutes
AUTO_DELETE_TIME = int(environ.get("AUTO_DELETE_TIME", "60000000000")) # Time in Seconds
...
class Var(object):
    ...
    if HAS_SSL:
        URL = "excess-phyllida-shahilhere-ec2ed26c.koyeb.app/"
    else:
        URL = "excess-phyllida-shahilhere-ec2ed26c.koyeb.app/"
